local config = function()
  ...
  presence.setup({
    ...
    workspace_text      = "Coding something impressive",                         -- Format string rendered when in a git repository (either string or function(project_name: string|nil, filename: string): string)
